...
-- Account (Published rows, groups included). silver_main_accounts reads it
-- first, the ERP chart second. konsol's ensure_reference_tables() creates it on
-- volumes that predate it. Identical to konsol's _REFERENCE_TABLE_DDL.
