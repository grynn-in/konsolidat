...
Open-source Enterprise Performance Management. Multi-entity consolidation, Excel-native budgeting, and variance analysis — powered by `=K.EPM()` in the spreadsheet your finance team already knows.
