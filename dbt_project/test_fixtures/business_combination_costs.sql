...
-- so net assets at book = 650, at fair value 1,580, and goodwill before costs = 8,300 - 1,580 = 6,720.
-- Each deal carries two Acquisition Costs lines: Legal 120 USD and Advisory 80 EUR (= 80 USD at the closing
-- rate), 200 USD in all, settled through the group's disposal_proceeds_account ZZ1000 (cash). The policies differ:
--   ZZG (acquisition_costs_treatment 'Expense')    acquires ZZS: IFRS 3.53, the costs are P&L of the period
--   ZZH (acquisition_costs_treatment 'Capitalise') acquires ZZT: the costs join the consideration, so goodwill is 6,920
-- Both groups declare the same accounts:
--   ZZ1800 goodwill | ZZ1900 fair-value adjustment | ZZ3500 investment | ZZ3400 NCI | ZZ4900 bargain gain
--   ZZ4950 disposal gain/loss | ZZ1000 proceeds (cash; also settles acquisition costs) | ZZ6900 amortisation expense
--   ZZ6950 acquisition costs
--
-- Expected journals in FY2026 P3 (USD):
--   ACQ-ZZG-ZZS-2026-03-15 (Expense, 9 lines):
--     Dr ZZ3000 100 | Dr ZZ3100 550 | Dr ZZ1900 930 | Dr ZZ1800 6,720 | Cr ZZ3500 8,300
--     Dr ZZ6950 120 costs (line 111) | Cr ZZ1000 120 proceeds (131) | Dr ZZ6950 80 costs (112) | Cr ZZ1000 80 proceeds (132)
--   ACQ-ZZH-ZZT-2026-03-15 (Capitalise, 7 lines):
--     Dr ZZ3000 100 | Dr ZZ3100 550 | Dr ZZ1900 930 | Dr ZZ1800 6,920 | Cr ZZ3500 8,300
--     Cr ZZ1000 120 proceeds (131) | Cr ZZ1000 80 proceeds (132)
-- Both sum to 0. Before row J4 the model ignored business_combination_costs: 5 lines per deal, goodwill 6,720 in both.
--
-- The deal tables do not exist live yet: the fixture creates the four it needs with konsol's exact
...
VALUES
  ...
  ('ZZG', 'ZZS', 'ZZ Subsidiary', 'USD',
   ...
   '', '', '', ''),
  ('ZZH', '', 'ZZ Holdings', 'USD',
   'partial', 'Local', 'Impairment only', 'Capitalise', 'Off', 'Recognise gain',
   'ZZ1800', 'ZZ1900', 'ZZ3500', 'ZZ3400', 'ZZ4900',
   'ZZ4950', 'ZZ1000', 'ZZ6900', 'ZZ6950'),
...
VALUES
  ...
  ('BC-ZZH-ZZT-2026-03-15', 'ZZH', 'ZZT', '2026-03-15', 100, 'USD', 8300, 650, 930, 6920, 0, 0, 'ZZ-OP-ZZT-1', 'partial');
...
VALUES
  ('BC-ZZG-ZZS-2026-03-15', 1, 'Legal', 120, 'USD', 'Share purchase agreement'),
  ('BC-ZZG-ZZS-2026-03-15', 2, 'Advisory', 80, 'EUR', 'Financial due diligence'),
  ('BC-ZZH-ZZT-2026-03-15', 1, 'Legal', 120, 'USD', 'Share purchase agreement'),
  ('BC-ZZH-ZZT-2026-03-15', 2, 'Advisory', 80, 'EUR', 'Financial due diligence');
