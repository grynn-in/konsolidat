-- konsolidat#206 (PR #211 review 3): an actual pairs only with the budget scenarios that budget its entity and
-- fiscal year. `+gold_variance_analysis assert_variance_budget_matches_year assert_variance_covers_budget_scenarios`
-- must BUILD and PASS on these rows.
--
-- Entity ZZE1 (USD), trial balance (period movement):
--   FY2025 P1: ZZ1000 cash Dr 900  | ZZ4000 revenue Cr 900
--   FY2026 P1: ZZ1000 cash Dr 1000 | ZZ4000 revenue Cr 1000
-- Declared scenarios: ACTUAL (actual), ZZ_B25 (budget, active), ZZ_B26 (budget, active).
-- Budget Sheet (epm_gold.budget_monthly_input), base layer, P1 on ZZ4000:
--   ZZ_B25 FY2025 -1100 (no FY2026 lines) | ZZ_B26 FY2026 -1200 (no FY2025 lines)
-- FY2025 actuals must appear only under ZZ_B25 and FY2026 actuals only under ZZ_B26; no actual grain under
-- the other year's budget, and none duplicated under budget_scenario_id ''.
--
...
VALUES
  ('ZZB1', 'ZZE1', 2025, 1, 'ZZ1000', 900, 0, '', 'ZZ-TBS-1', '2025-02-05 09:00:00', ''),
  ('ZZB1', 'ZZE1', 2025, 1, 'ZZ4000', 0, 900, '', 'ZZ-TBS-1', '2025-02-05 09:00:00', ''),
  ('ZZB2', 'ZZE1', 2026, 1, 'ZZ1000', 1000, 0, '', 'ZZ-TBS-2', '2026-02-05 09:00:00', ''),
  ('ZZB2', 'ZZE1', 2026, 1, 'ZZ4000', 0, 1000, '', 'ZZ-TBS-2', '2026-02-05 09:00:00', '');
...
VALUES
  ('ZZB1', 'ZZ-TBS-1', 'ZZE1', 2025, 1, 2, '2025-02-05 09:00:00', 'Period movement'),
  ('ZZB2', 'ZZ-TBS-2', 'ZZE1', 2026, 1, 2, '2026-02-05 09:00:00', 'Period movement');
INSERT INTO epm_gold.scenario_definitions
  (scenario_id, scenario_name, scenario_type, is_active)
VALUES
  ('ACTUAL', 'Actual', 'actual', 1),
  ('ZZ_B25', 'ZZ budget 2025', 'budget', 1),
  ('ZZ_B26', 'ZZ budget 2026', 'budget', 1);
...
VALUES
  ('ZZ_B25', 'ZZE1', 2025, 'ZZ4000', '', '', 1, -1100, 'base'),
