...
-- (data_source 'gl') under scenario_id 'ACTUAL'. The site declares ACTUAL (type actual) but INACTIVE,
-- so the variance models would drop every actual: the test names ('ACTUAL', 'gl', 'inactive').
