-- Must-flag fixture for assert_deal_rate_resolved (konsolidat#198 row J9; PR #203 review 3 + 4): a submitted
-- deal whose consideration is stated in a currency the group has no governed Closing rate for.
...
-- the header when the deal has lines). Only EUR -> USD Closing/Average rates exist for FY2026 P3.
--
...
VALUES
  ('BC-ZZG-ZZS-2026-03-15', 1, 'Cash', 6500, 'GBP', '2026-03-15', 'Cash paid at completion, in sterling: no GBP rate is governed');
