...
-- Entity ZZS (EUR) is acquired 100% on 2026-03-15 (FY2026 P3) for only 1,200 USD cash (a distressed seller).
-- konsol's acquired balance sheet (EUR; Dr positive, Cr negative; closing rate EUR->USD 1.0 for FY2026 P3):
...
-- so net assets at book = 650, at fair value 1,580, and consideration - fair-value net assets = 1,200 - 1,580 = -380:
-- negative goodwill, which IFRS 3.34 books as a gain in P&L, never as an asset.
--
-- Expected journal ACQ-ZZG-ZZS-2026-03-15 in FY2026 P3 (USD):
--   Dr ZZ3000   100  equity_eliminated
--   Dr ZZ3100   550  equity_eliminated
--   Dr ZZ1900   930  fva
--   Cr ZZ4900   380  bargain_gain   (line 105; no goodwill line)
--   Cr ZZ3500 1,200  investment
-- which sums to 0. Before row J4 the model posted a `goodwill` line of -380 instead (a credit to the goodwill asset).
--
