-- Closing-period rates, must flag (konsolidat#199 row D9): the governed-rate guard must still REFUSE
-- `+gold_consolidated_trial_balance` on these rows, naming "EUR->USD FY2026 P12 missing".
--
-- The same entity, files, calendar and chart as closing_period_rates.sql, minus the FY2026 P12 rates:
-- the Closing-period rule maps FY2025 P13 to FY2025 P12 (whose rates exist), and invents nothing
-- for a Regular period without rates. FY2025 P12 and P13 are fine; FY2026 P12 is the one key named.
--
