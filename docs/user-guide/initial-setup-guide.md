...
Only needed if you're syncing live data from D365, SAP, or ERPNext. Skip this if your entities upload trial balances instead (single or bulk, in konsol-exec at `/konsol-exec/uploads`). There is no demo data.
